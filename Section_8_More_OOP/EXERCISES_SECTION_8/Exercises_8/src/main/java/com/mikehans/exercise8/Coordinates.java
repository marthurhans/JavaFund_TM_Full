...
//        int rank = ((int) chessCoords.charAt(1));
        //THE COMMENTED-OUT LINE --> wont work
        //BECAUSE chars already HAVE an int assigned to them.
        //To force java to make a '1' char to be a 1 int:
        //Convert the char toString --> Parse the String into an int
        x = getXForFile(file);
        y = getYForRank(rank);
    }
